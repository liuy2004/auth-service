...
-- 插入 root 组织机构
INSERT INTO `colors_auth`.`auth_organization` (`id`, `name`, `display_name`, `code`, `layer`, `sort`, `parent_id`, `path`, `description`, `create_time`, `creator`, `modify_time`, `modifier`)
VALUES (1, '', '', 'root', 0, 1, 0, '', '根节点', '2018-06-05 13:55:53', 1, '2018-06-05 13:56:22', 1);

-- 插入 未分组 信息
INSERT INTO `colors_auth`.`auth_role_group` (`id`, `name`, `code`, `sort`, `create_time`, `creator`, `modify_time`, `modifier`)
VALUES (1, '未分组', 'nogroup', 1, '2018-06-05 13:59:34', 1, '2018-06-05 13:59:34', 1);